        ...
        const helpTopics = ref([
            {
                ...
                content: 'Nhấn vào nút "Add Config" ở góc trên bên phải, điền đầy đủ các thông tin và nhấn "Lưu".'
            },
            {
                title: 'Chỉnh sửa cấu hình đã có',
                content: 'Chọn biểu tượng ba chấm (...) tại mỗi dòng cấu hình, sau đó chọn "Edit Config".'
            },
            {
                title: 'Xóa cấu hình',
