<script lang="ts" src="@/scripts/create-configs/components/list.ts"></script>
                                ...
                                <tbody v-if="listItems && listItems.length > 0">
                                    <tr
                                        ...
                                        <td
                                            ...
                                            :title="itemData.botpress_bot_id">
                                            <span class="truncate-text">{{
                                                itemData.botpress_bot_id
                                            }}</span>
                                        </td>
                                        <td
                                            class="text-left text-truncate"
                                            :title="itemData.bot_name">
                                            <span class="truncate-text">{{
                                                itemData.bot_name
                                            }}</span>
                                        </td>
